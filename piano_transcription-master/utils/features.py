...
def pack_mazurka_dataset_to_hdf5(args):
    """Load & resample Mazurka audio files, then write to hdf5 files.
    ...
    # Paths
    csv_path = os.path.join(dataset_dir, 'maestro-v2.0.0.csv')
    waveform_hdf5s_dir = os.path.join(workspace, 'hdf5s', 'mazurka')
